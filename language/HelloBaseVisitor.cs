...
public partial class HelloBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IHelloVisitor<Result> {
	/// <summary>
	/// Visit a parse tree produced by <see cref="HelloParser.greet"/>.
	/// <para>
	...
	public virtual Result VisitGreet([NotNull] HelloParser.GreetContext context) { return VisitChildren(context); }
}
